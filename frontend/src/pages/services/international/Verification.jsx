...
import '../domestic/Verification.css'; // Assuming you have a CSS file for styling

const Verification = () => {
    return (
    <div className="verification-container">
        <h1 className="verification-title">Verification Builds Trust</h1>
        <section className="verification-section">
        <h6 className="verification-subtitle">VERIFYING EMPLOYMENT HISTORY</h6>
        ...
        <h6 className="verification-subtitle">WHAT INFORMATION CAN I EXPECT?</h6>
        <p className="verification-text">
            Our comprehensive employment history reports will detail the following information:
        </p>
        <ul className="verification-list">
            <li>Dates of employment (job start and end dates)</li>
            <li>Job duties</li>
            <li>Reason for termination (varies according to State laws)</li>
            <li>Title held</li>
        </ul>
        <h6 className="verification-subtitle">BENEFITS OF EMPLOYMENT VERIFICATION</h6>
        <p className="verification-text">Employment verification reports allow potential employers to:</p>
        <ul className="verification-list">
            <li>Analyze any inconsistencies within the resume</li>
            <li>Ensure no misleading information was provided</li>
            <li>Gain insight into potential employee’s trustworthiness</li>
            <li>Learn if the applicant is truly qualified for the position</li>
            <li>Obtain peace of mind about the hiring decision</li>
        </ul>
        <h6 className="verification-subtitle">WE’RE HERE TO HELP</h6>
        <p className="verification-text">
        ...
        <h6 className="verification-title">VERIFYING EDUCATION HISTORY</h6>
        <p className="verification-text">
        ...
        <h6 className="verification-subtitle">WHAT CAN BE FOUND WHEN VERIFYING A POTENTIAL EMPLOYEE’S EDUCATION HISTORY?</h6>
        <p className="verification-text">
